...
import com.booknest.userservice.infrastructure.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOriginPatterns(List.of("http://localhost:*", "https://booknest.com"));
